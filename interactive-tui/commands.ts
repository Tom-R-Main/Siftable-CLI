...
export const INTERACTIVE_MODEL_CHOICES: InteractiveModelChoice[] = [
  ...
  },
  {
    ...
    label: "Kimi K3",
    description: "OpenRouter · 1M context · always reasons",
    aliases: ["kimi", "kimi-k3", "k3", "moonshotai/kimi-k3", "openrouter:moonshotai/kimi-k3"],
    auth: "api-key",
  ...
  },
  {
    ...
    label: "Kimi K2.6",
    description: "OpenRouter · fast reasoning",
    aliases: [
      "kimi-fast",
      "kimi-k2.6",
      "k2.6",
